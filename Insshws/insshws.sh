...
wget -O /usr/local/bin/ws-dropbear raw.githubusercontent.com/mousethain/tahu/main/Insshws/dropbear-ws.py.txt
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/messiey/rocky/master/Insshws/ws-stunnel.txt
...
wget -O /etc/systemd/system/ws-dropbear.service https://raw.githubusercontent.com/messiey/rocky/master/Insshws/service-wsdropbear.txt && chmod +x /etc/systemd/system/ws-dropbear.service

#System SSL/TLS Websocket-SSH Python
wget -O /etc/systemd/system/ws-stunnel.service https://raw.githubusercontent.com/messiey/rocky/master/Insshws/ws-stunnel.service.txt && chmod +x /etc/systemd/system/ws-stunnel.service
