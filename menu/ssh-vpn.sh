...
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/messiey/rocky/master/Insshws/password.txt"
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/messiey/rocky/master/configuration/nginx.conf"
...
cd
cd
wget -O /usr/bin/badvpn-udpgw https://raw.githubusercontent.com/messiey/rocky/master/udpgw/badvpn-udpgw && chmod +x  /usr/bin/badvpn-udpgw
#system badvpn 7300
wget -O /etc/systemd/system/svr-7300.service https://raw.githubusercontent.com/messiey/rocky/master/udpgw/svr-7300.service && chmod +x  /etc/systemd/system/svr-7300.service
#system badvpn 7200
wget -O /etc/systemd/system/svr-7200.service https://raw.githubusercontent.com/messiey/rocky/master/udpgw/svr-7200.service && chmod +x  /etc/systemd/system/svr-7200.service
#system badvpn 7100
wget -O /etc/systemd/system/svr-7100.service https://raw.githubusercontent.com/messiey/rocky/master/udpgw/svr-7100.service && chmod +x  /etc/systemd/system/svr-7100.service
...
wget https://raw.githubusercontent.com/messiey/rocky/master/scurity/rules.zip
unzip rules.zip
...
wget -q -O /etc/cyber.site "https://raw.githubusercontent.com/messiey/rocky/master/issue.net"
...
wget https://raw.githubusercontent.com/messiey/rocky/master/Insshws/bbr.sh && chmod +x bbr.sh && ./bbr.sh
